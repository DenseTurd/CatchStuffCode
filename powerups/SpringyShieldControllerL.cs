...
public class SpringyShieldControllerL : MonoBehaviour
{
    ...
    public static SpringyShieldControllerL instance { get; set; }
    ...
    private void Start()
    {
        ...
        ShieldBurstControl.instance.springyL = true;
        foreach (GameObject s in ShieldBurstControl.instance.shields)
        {
            Instantiate(springyShieldShieldL, Camera.main.transform);
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.tag == "BadStuff")
        {
            ...
            ShieldBurstControl.instance.springyL = false;
            ShieldBurstControl.instance.springyShieldShieldsL.Clear();
            instance = null;
            Destroy(gameObject);
            Destroy(this);
        }
